 ...
 * with a visually-hidden label. Renders into the caller's shadow root, so that
 * component must compose `shared.css` (for `.visually-hidden`) into its styles,
 * as our components do by default.
 */
