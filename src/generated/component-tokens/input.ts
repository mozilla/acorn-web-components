...
export default css`
  ...
  --input-text-opacity-disabled: 0.7;
  --input-width: var(--size-item-small);
  --input-nova-search-border-radius: var(--border-radius-circle);
  --input-border-color: var(--border-color-interactive);
  --input-folder-gap: var(--space-medium);
  --input-text-background-color-disabled: light-dark(rgba(207, 207, 216, 0.33), rgba(0, 0, 0, 0.33));
